...
ROOK_EXTERNAL_FSID=ak://rook-ceph/ROOK_EXTERNAL_FSID
ROOK_EXTERNAL_CEPH_MON_DATA=ak://rook-ceph/ROOK_EXTERNAL_CEPH_MON_DATA
ROOK_EXTERNAL_USER_SECRET=ak://rook-ceph/ROOK_EXTERNAL_USER_SECRET
ROOK_EXTERNAL_USERNAME=ak://rook-ceph/ROOK_EXTERNAL_USERNAME
MONITORING_ENDPOINT=ak://rook-ceph/MONITORING_ENDPOINT
MONITORING_ENDPOINT_PORT=ak://rook-ceph/MONITORING_ENDPOINT_PORT
ROOK_EXTERNAL_DASHBOARD_LINK=ak://rook-ceph/ROOK_EXTERNAL_DASHBOARD_LINK
CSI_RBD_NODE_SECRET=ak://rook-ceph/CSI_RBD_NODE_SECRET
CSI_RBD_PROVISIONER_SECRET=ak://rook-ceph/CSI_RBD_PROVISIONER_SECRET
...
CEPHFS_POOL_NAME=ceph-fs_data
CEPHFS_METADATA_POOL_NAME=ceph-fs_metadata
CEPHFS_FS_NAME=ceph-fs
CSI_CEPHFS_NODE_SECRET=ak://rook-ceph/CSI_CEPHFS_NODE_SECRET
CSI_CEPHFS_PROVISIONER_SECRET=ak://rook-ceph/CSI_CEPHFS_PROVISIONER_SECRET
CSI_CEPHFS_NODE_SECRET_NAME=csi-cephfs-node
CSI_CEPHFS_PROVISIONER_SECRET_NAME=csi-cephfs-provisioner
RBD_POOL_NAME=ceph-vm
...
: "${ROOK_EXTERNAL_ADMIN_SECRET:=admin-secret}" #can't use both admin-secret and user-secret
