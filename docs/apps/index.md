...
1. Run `/add-app` in Claude Code — it prompts for app name, namespace, helm chart type, ingress, auth, and optional features (Kopiur, CNPG, zeroscaler, Gatus), then generates all files
